...
export function withComments(value) {
  ...
  console.log((x + y) * 3);  //sum of values stored on x and y, returns the vqlue * 3
}
withComments(4, 5);  // the command returns the value * 3
...
takes three numbers, and
returs their sum . 
*/
  console.log(a + b + c);
}
multiLinesComments(6, 7, 8);
